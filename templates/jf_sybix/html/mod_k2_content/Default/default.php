...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul>
	...
	<div class="moduleItemText">
      ...
      <span class="moduleItemDateCreated"><?php echo JHTML::_('date', $item->created, JText::_('TPL_JF_SYBIX_DATE_FORMAT')); ?></span>
      <?php endif; ?>
      ...
      <?php if($params->get('itemAuthor')): ?>
	      <?php //echo K2HelperUtilities::writtenBy($item->authorGender); ?>
				...
				<a class="moduleItemAuthor" rel="author" title="<?php echo K2HelperUtilities::cleanHtml($item->author); ?>" href="<?php echo $item->authorLink; ?>"><?php echo $item->author; ?></a>
				<?php else: ?>
