...
<div id="k2Container" class="itemListGallery itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('subCatColumns'), 1).'%;"'; ?>>
				<div class="subCategory">
					...
					<!-- Subcategory title -->
					<a href="#" data-filter=".<?php echo $subCategory->alias; ?>">
	...
	<div class="itemList">
		...
		<div id="itemListLeading">
			...
			<div class="<?php echo $item->category->alias; ?> itemContainer<?php echo $lastContainer; ?>"<?php echo (count($this->leading)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('num_leading_columns'), 1).'%;"'; ?>>
				<?php
	...
	<!-- Modal -->
	<div class="modal fade" id="image_lightbox" tabindex="-1" role="dialog" aria-labelledby="image_lightbox_label">
