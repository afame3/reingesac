...
<body class="site 
	...
	<footer>
		...
		<div class="copyright-area">
			<div class="container">
				<p>
					<a href="https://reingesac.com/" target="_blank" class="jflink">Reingesac</a>
					Copyright &copy; <?php echo date('Y'); ?> . Modified by <a href="https://headsystems.pe/ " target="_blank" title="Kreatif">Head Systems</a>
				</p>
			</div>
		</div>
	</footer>
	...
	<div class="copyright-area">
		<div class="container">
			<p>
				<a href="https://reingesac.com/" target="_blank" class="jflink">reingesac</a>
				Copyright &copy; <?php echo date('Y'); ?> . Modificado por <a href="https://headsystems.pe/" target="_blank" title="Kreatif">Head Systems</a>
			</p>
		</div> 
	</div>
	<?php endif; ?>
